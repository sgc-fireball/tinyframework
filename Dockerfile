...
RUN add-apt-repository ppa:ondrej/php && \
    ...
    php8.2-ssh2 php8.2-sqlite \
    \
    php8.3-cli php8.3-readline php8.3-mysql php8.3-mbstring php8.3-redis php8.3-amqp php8.3-xml php8.3-intl php8.3-imap \
    php8.3-zip php8.3-xdebug php8.3-opcache php8.3-curl php8.3-gd php8.3-ftp php8.3-imagick php8.3-swoole php8.3-ssh2 php8.3-sqlite
